...
function r_enqueue_block_editor_assets()
{
    wp_register_script(
        'sml_blocks_bundle',
        plugins_url('/custom_blocks/version_one/dist/bundle.js', SML_PLUGIN_URL),
        sml_get_block_dependencies(),
        filemtime(plugin_dir_path(SML_PLUGIN_URL) . '/custom_blocks/version_one/dist/bundle.js'),
...
function r_enqueue_block_assets()
{
    wp_register_style(
        'sml_blocks',
        plugins_url('/custom_blocks/version_one/dist/blocks-main.css', SML_PLUGIN_URL)
    );
